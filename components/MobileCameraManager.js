...
class MobileCameraManager {
  ...
  onTouchStart(event) {
    if (event.nativeEvent.touches.length === 1) {
      ...
      console.log("worldx = touchx * ", (this.camera.right - this.camera.left), " / 2 + ", this.camera.position.x)
      console.log("worldz = touchy * ", (this.camera.top - this.camera.bottom), " / 2 + ", this.camera.position.z)
